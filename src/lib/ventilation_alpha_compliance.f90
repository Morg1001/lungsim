...
! 0.00007785 (mL/Pa) per cm 
   ...
   ! get trach_compliance = 0.00025459136844330573
      ...
      do ne = 1,num_elems 
       ...
       k = 2.1_dp! decay rate k solved with desmoes 
       !compliance(ne) =  trach_compliance 
       compliance(ne)= exp(-k*order + 2.5_dp) + trach_compliance! Scale compliance down the airways (increases down the airways)
      enddo
